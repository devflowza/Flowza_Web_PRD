...
const productDetailsMap: Record<string, ProductDetail> = {
  finance: {
    ...
    related: [
      { id: 'spamaster', name: 'FlowZa Spa Master', tagline: 'Complete Wellness & Spa Management', color: '#f43f5e', colorSecondary: '#e11d48', imageKey: 'spamaster', pexelsImage: '' },
      { id: 'logispro', name: 'FlowZa LogisPro', tagline: 'Smart Logistics Platform', color: '#38bdf8', colorSecondary: '#0ea5e9', imageKey: 'logispro', pexelsImage: '' },
      { id: 'qrforge', name: 'FlowZa QRForge', tagline: 'Advanced QR Code Management Platform', color: '#f59e0b', colorSecondary: '#d97706', imageKey: 'qrforge', pexelsImage: '' },
      { id: 'pos', name: 'FlowZa POS', tagline: 'Complete Cloud ERP + Point of Sale', color: '#8b5cf6', colorSecondary: '#7c3aed', imageKey: 'pos', pexelsImage: '', lightBg: true },
      { id: 'fleetza', name: 'FlowZa Fleetza', tagline: 'Cloud ERP for Rental Car Companies', color: '#7c5ff5', colorSecondary: '#3730a3', imageKey: 'fleetza', pexelsImage: '' },
      { id: 'club', name: 'FlowZa Club', tagline: 'Club & Membership Management', color: '#9333ea', colorSecondary: '#6b21a8', imageKey: 'club', pexelsImage: '' },
    ],
  },
  ...
  spamaster: {
    ...
    related: [
      { id: 'finance', name: 'FlowZa Finance', tagline: 'All-in-One Accounting & ERP', color: '#10b981', colorSecondary: '#059669', imageKey: 'finance', pexelsImage: '' },
      { id: 'logispro', name: 'FlowZa LogisPro', tagline: 'Smart Logistics Platform', color: '#38bdf8', colorSecondary: '#0ea5e9', imageKey: 'logispro', pexelsImage: '' },
      { id: 'qrforge', name: 'FlowZa QRForge', tagline: 'Advanced QR Code Management Platform', color: '#f59e0b', colorSecondary: '#d97706', imageKey: 'qrforge', pexelsImage: '' },
      { id: 'pos', name: 'FlowZa POS', tagline: 'Complete Cloud ERP + Point of Sale', color: '#8b5cf6', colorSecondary: '#7c3aed', imageKey: 'pos', pexelsImage: '', lightBg: true },
      { id: 'fleetza', name: 'FlowZa Fleetza', tagline: 'Cloud ERP for Rental Car Companies', color: '#7c5ff5', colorSecondary: '#3730a3', imageKey: 'fleetza', pexelsImage: '' },
