...
const productDetailsMap: Record<string, ProductDetail> = {
  finance: {
    ...
    related: [
      { id: 'spamaster', name: 'FlowZa Spa Master', tagline: 'Complete Wellness & Spa Management', color: '#f43f5e', colorSecondary: '#e11d48', imageKey: 'spamaster', pexelsImage: '/product-spamaster.webp' },
      { id: 'logispro', name: 'FlowZa LogisPro', tagline: 'Smart Logistics Platform', color: '#38bdf8', colorSecondary: '#0ea5e9', imageKey: 'logispro', pexelsImage: '/product-logispro.webp' },
      ...
      { id: 'pos', name: 'FlowZa POS', tagline: 'Complete Cloud ERP + Point of Sale', color: '#8b5cf6', colorSecondary: '#7c3aed', imageKey: 'pos', pexelsImage: '/product-pos.webp', lightBg: true },
      { id: 'fleetza', name: 'FlowZa Fleetza', tagline: 'Cloud ERP for Rental Car Companies', color: '#7c5ff5', colorSecondary: '#3730a3', imageKey: 'fleetza', pexelsImage: '/product-fleetza.webp' },
